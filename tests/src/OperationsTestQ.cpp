...
INSTANTIATE_TYPED_TEST_CASE_P(SeqToposortQ, OperationsTest, P1);
INSTANTIATE_TYPED_TEST_CASE_P(ParToposortQ, OperationsTest, P2);
INSTANTIATE_TYPED_TEST_CASE_P(PulsecountQ, OperationsTest, P3);
INSTANTIATE_TYPED_TEST_CASE_P(SubtreeQ, OperationsTest, P4);
