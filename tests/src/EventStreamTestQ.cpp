...
INSTANTIATE_TYPED_TEST_CASE_P(SeqToposortQ, EventStreamTest, P1);
INSTANTIATE_TYPED_TEST_CASE_P(ParToposortQ, EventStreamTest, P2);
INSTANTIATE_TYPED_TEST_CASE_P(PulsecountQ, EventStreamTest, P3);
INSTANTIATE_TYPED_TEST_CASE_P(SubtreeQ, EventStreamTest, P4);
