...
INSTANTIATE_TYPED_TEST_CASE_P(ELM, TransactionTest, ELMEngine<parallel_queue>);
INSTANTIATE_TYPED_TEST_CASE_P(PulseCount, TransactionTest, PulseCountEngine<parallel_queue>);
INSTANTIATE_TYPED_TEST_CASE_P(SourceSet, TransactionTest, SourceSetEngine<parallel_queue>);
